...
// The underline view is aligned to .bottomLeading, so that we can programmatically set its .padding(.leading, _) using a @State
// value.
...
// The MoveUnderlineButton uses a GeometryReader to find its own width and minX in order to set the respective values for the
// underline view
